...
--- @field public Food Type
--- @field public Key Type
--- @field public KeyRing Type
--- @field public Literature Type
--- @field public Map Type
--- @field public Moveable Type
--- @field public Normal Type
